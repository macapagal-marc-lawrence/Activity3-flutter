          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    _buildText("Marc Lawrence M. Macapagal",
                        style: const TextStyle(
                            fontSize: 24, fontWeight: FontWeight.bold)),
                    _buildText("Frontend Developer"),
                    _buildText("+639503273913"),
                    _buildText("macapagalmarck@gmail.com"),
                  ],
                ),
              ),
              const SizedBox(height: 20),
              _buildSection("Biography",
                  "Marc is a passionate Frontend Developer with experience in building dynamic websites and applications. He has a keen interest in optimizing system performance and creating scalable solutions",
              ...
              _buildSection("Education", [
                ...
                "Senior High School - Adelle Grace Montesorri Inc. (2020-2022)",
                "High School - Arayat Institute Inc. (2016-2020)",
                "Grade School - Arayat Central Elementary School (2009-2015)"
