...
class JenzellePage extends StatelessWidget {
  const JenzellePage({super.key});

  @override
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        middle: const Text("Jenzelle's Page"),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Center(
                child: CircleAvatar(
                  backgroundImage: AssetImage('images/jenzelle.jpg'),
                  radius: 100,
                ),
              ),
              ...
              Center(
                child: Column(
                  children: [
                    _buildText("Jenzelle A. Luriz",
                        style: const TextStyle(
                            fontSize: 24, fontWeight: FontWeight.bold)),
                    _buildText("Frontend Developer"),
                    _buildText("09464204759"),
                    _buildText("jenzelleluriz304@gmail.com"),
                  ],
                ),
              ),
              const SizedBox(height: 20),
              _buildSection("Biography",
                  "Jenzelle is a passionate Frontend Developer with experience in building dynamic websites and applications. He has a keen interest in optimizing system performance and creating scalable solutions",
              ...
              _buildSection("Education", [
                ...
                "Justino Sevilla High School - Manga Cacutud (2016-2020)",
                "Cupang Elementary SchoolCupang Arayat (2010-2016)"
